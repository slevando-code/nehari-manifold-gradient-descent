...
The folder 1Dequations contains solvers for the ODE $u''''+bu''+cu=f(u)$ on $R$.

The folder 2Dequations contains solvers for the PDE $a\Delta^2u-b\Delta u+(c\cdot\nabla)^2u+u=f(u)$ on $R^2$.
