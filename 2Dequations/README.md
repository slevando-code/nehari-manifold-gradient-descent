...
A collection of m-files for approximating nontrivial solutions of the PDE Lu=f(u) on R^2 for various nonlinear terms f(u), where Lu=a Delta^2u -b * Delta u +(c * nabla)^2u+u.
