function E=gradsolver_sum(p,q,a,b,c,A,B,Nx,Ny,tol,u,delta,plot_final)


% Numerically approximate solutions of
% u_xxxx+2u_xxyy+u_yyyy-b(u_xx+u_yy)+c^2u_xx+au=|u|^(p-1)*u+|u|^(q-1)*u
% Sample usage: 
% E=gradsolver_sum(3,6,0,1,0,10,10,500,500,1e-10,0,1,1)
% E=gradsolver_sum(3,6,1,-1.7,0,20,20,1000,1000,1e-10,0,1,1)
% E=gradsolver_sum(3,6,1,0,1.35,20,20,1000,1000,1e-10,0,1,1)
