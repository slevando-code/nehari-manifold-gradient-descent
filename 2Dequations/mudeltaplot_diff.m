function V =mudeltaplot_diff(p,q,a,b,c,A,B,Nx,Ny,tol,u,Delta)
...
% Sample usage:
% V=mudeltaplot_diff(3,6,1,-1.7,0,20,20,500,500,1e-10,0,.4:.1:1.6)
% V=mudeltaplot_diff(3,6,1,0,1.35,20,20,500,500,1e-10,0,.4:.1:1.4)
% V=mudeltaplot_diff(3,6,0,1,0,10,10,500,500,1e-10,0,.4:.1:1.6)
