function ratioplot_sum(p,q,b,c,A,Nx,tol,u,delta)

% Plot ratios of H^2 norm of differences between successive iterates for
% each algorithm approximating solutions of u''''+bu''+cu=|u|^(p-1)*u+|u|^(q-1)*u
...
% Sample usage: ratioplot_sum(3,6,-3,1,100,4000,1e-10,0,1)
